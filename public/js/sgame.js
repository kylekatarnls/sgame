...
//# sourceMappingURL=lib/jquery-1.11.0.min.map
*/
...
var Mobile, Player, Positionable, Wall, ajaxUrl, b, cHeight, cWidth, height, plugins, waitForNewMessages, width,
 ...
 * Build: http://modernizr.com/download/#-fontface-backgroundsize-borderradius-boxshadow-opacity-rgba-textshadow-cssanimations-cssgradients-csstransforms-csstransforms3d-csstransitions-input-inputtypes-shiv-cssclasses-teststyles-testprop-testallprops-prefixes-domprefixes-load
 */
...
plugins = function(list) {
  ...
  for (_i = 0, _len = list.length; _i < _len; _i++) {
    ...
    _results.push(delete window[plugin]);
  }
  return _results;
};
