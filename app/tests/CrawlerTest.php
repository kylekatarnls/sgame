...
class CrawlerTest extends TestCase {
	...
	public function testCrawler()
	{
		...
		$this->assertTrue(is_array(Crawler::getDataFromUrl('https://insearch-intranet.selfbuild.fr/')), "Crawler::getDataFromUrl('https://p.holowar.com/duel') devrait retourner un array");
